...
let img;
function preload() {
  img = loadImage('https://storytellers.link/story-jam-reveal/img/extended.svg');
}
...
function setup() {
  ...
  createCanvas(canvasWidth, canvasWidth, canvasElement);
...
function draw() {
  ...
  image(img, p1.currentState.x - 0.5*diameter, p1.currentState.y - 0.5*diameter, diameter, diameter, );
}
